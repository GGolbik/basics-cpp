#ifndef GGOLBIK_CPLUSPLUS_SOCKET_SERVER_H
#define GGOLBIK_CPLUSPLUS_SOCKET_SERVER_H
...
public: // methods
  /**
   * Opens the socket. Return false if server failed to open socket or is already open.
   */
  bool open();
  /**
