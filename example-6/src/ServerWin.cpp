...
Server::Server(unsigned short port, std::string interfaceAddress) : port{port}, interfaceAddress{interfaceAddress}, enabled{false}, running{false}, listenSocket{INVALID_SOCKET} {}
 ...
 * is defined in header <ws2tcpip.h>
 * 
...
static bool listenOnSocket(SOCKET socket)
{
  ...
  // SOMAXCONN; // max incoming connections
